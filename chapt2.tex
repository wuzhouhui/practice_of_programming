...
for example, functions like \textit{strchr} and \textit{strstr} search for
...
to the amount of data to be seached; doubling the number of elements will
...
\begin{wellcode}
    ...
    /* Vaules are Unicode/ISO10646 encoding. */
    Nameval htmlchars[] = {
        "AElig",    0x00c6,
        "Aacute",   0x00c1,
        "Acirc",    0x00c2,
...
\textit{\verb'binary'} search. The binary search algorithm is an orderly
...
=======
>>>>>>> 448c17843ed85b1907abc41f5a00e3728a7c7bb4
