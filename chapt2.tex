...
intrinsically (本质地) as a chain of unknown a \term{priori} size, such as
...
\begin{tikzpicture}
    ...
    \node at (5, -3.25) {\verb'name 2'};
    \node at (5, -3.75) {\verb'value 2'};
\end{tikzpicture}
\end{center}
...
The hash function returns the result modulo the size of the array. If the
