...
\begin{tikzpicture}
    ...
    \draw[->] (1.5, -0.5) -- (1.5, 0);
    \draw[->] (9.5, -0.5) -- (9.5, 0);
    \node at(0.5, -0.7) {\textbf{\texttt{last}}};
    \node at(1.5, -0.7) {\textbf{\texttt{i}}};
    \node at(9.5, -0.7) {\textbf{\texttt{n - 1}}};
\end{tikzpicture}

At the top of the \verb'for' loop, elements \verb'1' through \verb'last' are strictly less than the pivot, elements \verb'last + l' through \verb'i - 1' are greater than or equal to the pivot, and elements \verb'i' through \verb'n - 1' have not been examined yet. Until \verb'v[i] >= v[0]', the algorithm may swap \verb'v[i]' with itself; this wastes some time but not enough to worry about.
...
\begin{tikzpicture}
    ...
    \draw[->] (7.5, -0.5) -- (7.5, 0);
    \draw[->] (9.5, -0.5) -- (9.5, 0);
    \node at(0.5, -0.7) {\textbf{\texttt{0}}};
    \node at(1.5, -0.7) {\textbf{\texttt{1}}};
    \node at(3.5, -0.7) {\textbf{\texttt{last}}};
    \node at(7.5, -0.7) {\textbf{\texttt{i}}};
    \node at(9.5, -0.7) {\textbf{\texttt{n - 1}}};
\end{tikzpicture}
