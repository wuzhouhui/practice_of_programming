...
\draw[thick, ->] (0.5, 1.25) -- (1.5, 1.25);
\draw[thick, ->] (0.5, 3.75) -- (1.5, 3.75);
\draw[thick, ->] (0.5, 5.25) -- (1.5, 5.25);
...
\begin{exercise}
    ...
    cases of a data structure called a \term{trie}. Most such data
...
Profiling is usually enabled with a special compiler flag or option. The
