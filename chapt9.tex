...
The generic term for such tools is \textbf{\textit{scripting languages}}
...
\textbf{\textit{virtual machine}}) that can be simulated on any real
...
\textbf{\textit{grammar}}, into (typically) a C or C++ program that, once
...
\textbf{\textit{threaded}} code that flattens the call stack completely.
...
is easy to see. In effect, we invent a \textbf{\textit{stack machine}} in
